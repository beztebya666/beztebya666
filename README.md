...
Self-hosted web consoles for infrastructure — Kubernetes, DNS, databases, automation.
From a single binary or one container to Helm charts and HA deployments · [bez666.tech](https://bez666.tech)
...
| **[etcd-ui](https://github.com/beztebya666/etcd-ui)** | UI for any etcd cluster — Kubernetes, Patroni, standalone or DIY. | `Go` | demo |
